      ...
      <?php
        session_start();
         ...
         try {
            ...
            echo "<TH> End Time </TH>";
            echo "</TR>";
            foreach( $dbh->query("select date, start, end from slot where coach_email is null and camp_number =".$_SESSION['camp'].";") as $row){
              echo '<form method="post" action="coachslot.php">';
     	        echo "<TR>";
      ...
      <?php
         ...
         try {
           ...
           echo "</TR>";
            ...
            foreach( $dbh->query("select date, start, end from slot where coach_email = '".$_SESSION["username"]."' and camp_number =".$_SESSION['camp'].";") as $row){
              echo '<form method="post" action="coachdeselect.php">';
     	        echo "<TR>";
